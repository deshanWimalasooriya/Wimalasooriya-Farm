...
const { getFarmSummary, addHenLog, addProduction, addExpense, addRevenue, getFarmAnalytics } = require('../controllers/farmController');
...
router.route('/analytics').get(protect, adminOrManager, getFarmAnalytics);
