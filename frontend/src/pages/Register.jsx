    ...
    <div className="min-h-[calc(100vh-80px)] bg-mountain-sand flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-xl border border-mountain-gray/20 animate-slide-up opacity-0" style={{ animationDelay: '0.1s' }}>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button 
            type="submit" 
            className="w-full py-4 bg-mountain-moss text-white rounded-xl font-bold text-lg hover:bg-mountain-brown transition-all duration-300 shadow-lg shadow-mountain-moss/30 hover:shadow-mountain-brown/30 transform hover:-translate-y-0.5 mt-2"
          >
            Register
          </button>
        </form>
